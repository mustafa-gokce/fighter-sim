...
#settings
startUDP=14700 #enter the starting udp port # for bot and map # progresses in increments of 5 * 2
telemetryUDP=15700 #enter the telemetry starting port # progresses in increments of 10
...
botdiff=1 # 1 = easy // 2 = normal // 3 = hard // 4 = expert #enemy bot difficulty
mavproxyMap=enable # enable // disable # you can see all vehicles in mavproxy map
...
UDP Ports       Telemetry   For Map       For Bot${ENDCOLOR}
Cessna Camera   $((telUDP=telUDP+10))       $((udp=udp+5))         $((udp=udp+5))${BLUE}
Zephry Camera   $((telUDP=telUDP+10))       $((udp=udp+5))         $((udp=udp+5))${ENDCOLOR}
Cessna 1        $((telUDP=telUDP+10))       $((udp=udp+5))         $((udp=udp+5))${BLUE}
Cessna 2        $((telUDP=telUDP+10))       $((udp=udp+5))         $((udp=udp+5))${ENDCOLOR}
Cessna 3        $((telUDP=telUDP+10))       $((udp=udp+5))         $((udp=udp+5))${BLUE}
Cessna 4        $((telUDP=telUDP+10))       $((udp=udp+5))         $((udp=udp+5))${ENDCOLOR}
Zephry 1        $((telUDP=telUDP+10))       $((udp=udp+5))         $((udp=udp+5))${BLUE}
Zephry 2        $((telUDP=telUDP+10))       $((udp=udp+5))         $((udp=udp+5))${ENDCOLOR}
Zephry 3        $((telUDP=telUDP+10))       $((udp=udp+5))         $((udp=udp+5))${BLUE}
Zephry 4        $((telUDP=telUDP+10))       $((udp=udp+5))         $((udp=udp+5))${ENDCOLOR}
Vtol            $((telUDP=telUDP+10))       $((udp=udp+5))         $((udp=udp+5))")
...
if [[ "$mapType" = "vehicle" ]]
then
screen -S vehicle -d -m bash -c "sim_vehicle.py -v ArduPlane -f gazebo-zephyr --add-param-file ~/test-ucusu/fighter-sim/params/cessna.parm  -m --mav20 -I$((c=c+1)) --out=127.0.0.1:$((udp=udp+5)) --out=127.0.0.1:$((udp=udp+5)) --out=127.0.0.1:$((telUDP=telUDP+10)) -l $location,0,0 --sysid $((cc=cc+1))"
screen -S bot -d -m bash -c "python3 ~/test-ucusu/fighter-sim/bot.py -m $mac -p $udp -b $botType -s $startUDP -d $botdiff"
screen -S vehicle -d -m bash -c "sim_vehicle.py -v ArduPlane -f gazebo-zephyr --add-param-file ~/test-ucusu/fighter-sim/params/zephyr.parm  -m --mav20 -I$((c=c+1)) --out=127.0.0.1:$((udp=udp+5)) --out=127.0.0.1:$((udp=udp+5)) --out=127.0.0.1:$((telUDP=telUDP+10)) -l $location,0,0 --sysid $((cc=cc+1))"
screen -S bot -d -m bash -c "python3 ~/test-ucusu/fighter-sim/bot.py -m $mac -p $udp -b $botType -s $startUDP -d $botdiff"
fi
...
screen -S vehicle -d -m bash -c "sim_vehicle.py -v ArduPlane -f gazebo-zephyr --add-param-file ~/test-ucusu/fighter-sim/params/zephyr.parm  -m --mav20 -I$((c=c+1)) --out=127.0.0.1:$((udp=udp+5)) --out=127.0.0.1:$((udp=udp+5)) --out=127.0.0.1:$((telUDP=telUDP+10)) -l $location,0,0 --sysid $((cc=cc+1))"
screen -S bot -d -m bash -c "python3 ~/test-ucusu/fighter-sim/bot.py -m $mac -p $udp -b $botType -s $startUDP -d $botdiff"
screen -S vehicle -d -m bash -c "sim_vehicle.py -v ArduPlane -f gazebo-zephyr --add-param-file ~/test-ucusu/fighter-sim/params/quadplane.parm  -m --mav20 -I$((c=c+1)) --out=127.0.0.1:$((udp=udp+5)) --out=127.0.0.1:$((udp=udp+5)) --out=127.0.0.1:$((telUDP=telUDP+10)) -l $location,0,0 --sysid $((cc=cc+1))"
...
if [[ "$mavproxyMap" = "enable" ]]
then
screen -S vehicle -d -m bash -c "mavproxy.py --master=127.0.0.1:$((startUDP=startUDP)) --master=127.0.0.1:$((startUDP=startUDP+10)) --master=127.0.0.1:$((startUDP=startUDP+10)) --master=127.0.0.1:$((startUDP=startUDP+10)) --master=127.0.0.1:$((startUDP=startUDP+10)) --master=127.0.0.1:$((startUDP=startUDP+10)) --master=127.0.0.1:$((startUDP=startUDP+10)) --master=127.0.0.1:$((startUDP=startUDP+10)) --master=127.0.0.1:$((startUDP=startUDP+10)) --master=127.0.0.1:$((startUDP=startUDP+10)) --master=127.0.0.1:$((startUDP=startUDP+10)) --map"
fi
